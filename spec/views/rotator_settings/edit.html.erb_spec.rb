...
RSpec.describe "rotator_settings/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit rotator_setting form" do
    render

    assert_select "form[action=?][method=?]", rotator_setting_path(@rotator_setting), "post" do
